    ...
    <div className="bg-[#f3f3f3] py-10 my-10 mx-5">
      <div className="flex flex-wrap justify-center gap-4 container mx-auto px-20">
        <div className=" flex justify-center items-center rounded-sm ">
          <Link to={"products/MacBook"} className="text-center bg-white py-8 px-12">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="55"
              fill="currentColor"
              class="bi bi-apple mx-auto mb-3"
              viewBox="0 0 16 16"
            >
        ...
        <div className=" flex items-center rounded-sm ">
          <Link to={"products/Windows"} className="text-center bg-white py-8 px-12">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="50"
              fill="currentColor"
              class="bi bi-microsoft mx-auto mb-3"
              viewBox="0 0 16 16"
            >
        ...
        <div className=" flex items-center rounded-sm ">
          <Link to={"products/Linux"} className="text-center bg-white py-8 px-12 ">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="50"
              fill="currentColor"
              class="bi bi-ubuntu mx-auto mb-3"
              viewBox="0 0 16 16"
            >
